...
contract SimpleBank {
    ...
    function deposit() public payable returns (uint) {
        /* Add the amount to the user's balance, call the event associated with a deposit,
          ...
          require(enrolled[msg.sender], "You need to be enrolled before deposit money");
    ...
    function withdraw(uint withdrawAmount) public payable returns (uint) {
        /* If the sender's balance is at least the amount they want to withdraw,
           ...
           require(balances[msg.sender] >= withdrawAmount, "Balance must be larger than requested withdrawAmount");
